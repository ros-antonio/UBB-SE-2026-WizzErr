SELECT
t.passenger_first_name AS PassengerFirstName,
t.passenger_last_name AS PassengerLastName,
...
WHERE u.user_id = 1;  -- This is a placeholder representing the currently logged-in user
GO